...
class PresentationTimeline {
	 ...
	 */
	constructor(presentationStartTime, presentationDelay, autoCorrectDrift = true) {
		/** @private {?number} */
	...
	notifySegments(references, periodStart) {
		...
		const lastReferenceEndTime = references[references.length - 1].endTime + periodStart;
